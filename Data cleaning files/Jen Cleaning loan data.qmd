...
```{r}
#export cleaned dataframe into csv file 
write.csv(debts_year_remove, "Cleaned data/Cleaned_debt_by_year.csv")
```
...
#write.csv(loan_year_remove, "Cleaned data/Cleaned_debt_loantype_year.csv")
write.csv(loan_year_remove, "Cleaned data/Cleaned_loantype_year.csv")
```
