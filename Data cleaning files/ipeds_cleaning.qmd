...
enrollment_2019 = pd.read_csv("../data/ipeds_demographics/EFFY2019_rv.csv")
enrollment_2018 = pd.read_csv("../data/ipeds_demographics/EFFY2018_rv.csv")
...
institution_characteristics.to_excel("CheckInstitutionCharacteristics.xlsx")
...
presidential_election_results <- read.csv("../Cleaned data/Cleaned_ipeds_state_demographics.csv")
