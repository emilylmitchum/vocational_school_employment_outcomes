...
# Create a copy of 2020-2022 (file limits)
ipeds_demographic_data_2020_2022 = ipeds_demographic_data[(ipeds_demographic_data["year"] == "2020") | (ipeds_demographic_data["year"] == "2021") | (ipeds_demographic_data["year"] == "2022")]

# Create a copy of 2023-2024 (file limits)
ipeds_demographic_data_2023_2024 = ipeds_demographic_data[(ipeds_demographic_data["year"] == "2023") | (ipeds_demographic_data["year"] == "2024")]
...
ipeds_demographic_data_2020_2022.to_csv(f"../Cleaned data/Cleaned_ipeds_state_demographics_2020_2022.csv", index=False)
ipeds_demographic_data_2023_2024.to_csv(f"../Cleaned data/Cleaned_ipeds_state_demographics_2023_2024.csv", index=False)
