...
```{r}
unemp_emp_ratio_df$date <- as.Date(unemp_emp_ratio_df$date, "%Y-%m-%d")
unemp_emp_ratio_df$employment_population_ratio <- as.numeric(unemp_emp_ratio_df$employment_population_ratio)
